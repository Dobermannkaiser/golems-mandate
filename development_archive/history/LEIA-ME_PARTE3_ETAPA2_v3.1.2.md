...
A v3.1.2 implementa a Etapa 2 da Parte 3: **Construção por fila**.
...
Continuam fora do escopo da v3.1.2:
...
- `AUDITORIA_FILA_DE_OBRAS_v3.1.2.txt`;
- `ROTEIRO_DE_TESTE_PARTE3_ETAPA2_v3.1.2.txt`;
- `VERIFICACAO_PARTE3_ETAPA2_v3.1.2.txt`;
- `SIMULACAO_FILA_DE_OBRAS_v3.1.2.txt`.
