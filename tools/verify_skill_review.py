...
def main() -> int:
    ...
    check("Versão candidata da Etapa 2 3.1.2", 'config/version="3.1.2"' in project)
    check("Save funcional da fila usa v9", "const SAVE_VERSION: int = 9" in save)
    check("Save da Parte 3 permanece isolado", "golems_mandate_part3_v3_save.json" in save)
